<%-- 
    Document   : home
    Created on : Oct 30, 2015, 10:43:46 AM
    Author     : apprentice
--%>
...
<html>
    ...
    <body>
        <div class="container">
            ...
            <div class="navbar">
                <ul class="nav nav-tabs">
                    ...
                    <li role="presentation">
                        <a href="${pageContext.request.contextPath}/finddvd">Find a DVD</a>
                    </li>
                </ul>
            </div>
        </div>
        <div class="container">
            ...
            <p>
                Welcome to the DVD Library project for the Software Guild - Java
                Cohort.
            </p>
        </div>
