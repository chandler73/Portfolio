...
public class DvdLibraryDaoDbImpl implements DvdLibraryDao {
    ...
    private static final String SQL_INSERT_DVD
            = "insert into dvds (title, release_date, mpaa_rating, director, studio, notes) values (?, ?, ?, ?, ?, ?)";
    ...
    private static final String SQL_UPDATE_DVD
            = "update dvds set title = ?, release_date = ?, mpaa_rating = ?, director = ?, studio = ?, notes = ? where dvd_id = ?";
    ...
    private static final class DVDMapper implements
            ParameterizedRowMapper<DVD> {
